...
HRSC is the main camera on board Mars-Express, OMEGA is the imaging spectrometer. Both acquired large datasets from early 2004, and now provides a nearly complete coverage of Mars. These services are used here to illustrate the common problem of idenfying observations of the same area from two different instruments.

## Steps


### Select OMEGA data of interest
...
### Send results to TOPCAT and edit the table
...
### Search HRSC images overlapping one cube
...
### Search HRSC images overlapping a set of cubes
...
### Displaying the results in Aladin
...
* Click Show associated FoV to display the footprints (bounding boxes) of OMEGA cubes.
* Do the same for the HSRC layer
...
See details here set a correct planetary display in TOPCAT:
